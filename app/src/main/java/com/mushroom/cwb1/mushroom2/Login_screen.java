    ...
    private boolean checkServer(String userName) throws ExecutionException, InterruptedException {
        ...
        if (serverCheckResult.get(0).equals("no results")) {
            ...
            for(int l=1; l<52; l++){
                ...
                newuser.setDrive(drive_1_km, drive_5_km, drive_10_km, drive_50_km, drive_100_km, drive_250_km, drive_500_km, drive_1000_km, drive_5000_km);
                ...
                newuser.setNb_challenge(nb_challenge_1, nb_challenge_5, nb_challenge_10, nb_challenge_50, nb_challenge_200, nb_challenge_500);
                ...
                newuser.setBiked_days(biked_days_1, biked_days_2, biked_days_5, biked_days_7, biked_days_14, biked_days_31, biked_days_100);
